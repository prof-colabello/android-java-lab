...
# Crea local.properties — garantisce che Gradle trovi sempre l'SDK
# indipendentemente dallo stato delle variabili d'ambiente della sessione
echo "sdk.dir=${ANDROID_SDK_ROOT}" > local.properties
ok "local.properties creato (sdk.dir=${ANDROID_SDK_ROOT})"
echo ""
